...
const ASSET_MANIFEST = {
  elena: { src: 'assets/art/characters/elena_sheet.png', fw: 150, fh: 210, h: 112 },
  arthur_muda: { src: 'assets/art/characters/arthur_muda_sheet.png', fw: 150, fh: 210, h: 112 },
  arthur_dewasa: { src: 'assets/art/characters/arthur_dewasa_sheet.png', fw: 150, fh: 210, h: 112 },
  arthur_buron: { src: 'assets/art/characters/arthur_buron_sheet.png', fw: 150, fh: 210, h: 112 },
  arthur_tua: { src: 'assets/art/characters/arthur_tua_sheet.png', fw: 150, fh: 210, h: 112 },
  bg2088_far: { src: 'assets/art/backgrounds/bg2088_far.png' }, bg2088_near: { src: 'assets/art/backgrounds/bg2088_near.png' },
  bg1944_far: { src: 'assets/art/backgrounds/bg1944_far.png', scale: 0.75, yOff: 2000 }, bg1944_mid: { src: 'assets/art/backgrounds/bg1944_mid.png', scale: 0.75, yOff: 300 },
  bg1968A_far: { src: 'assets/art/backgrounds/bg1968A_far.png', scale: 0.75, yOff: 50 }, bg1968A_mid: { src: 'assets/art/backgrounds/bg1968A_mid.png', scale: 0.75 },
  bg1968B_far: { src: 'assets/art/backgrounds/bg1968B_far.png' }, bg1968B_mid: { src: 'assets/art/backgrounds/bg1968B_mid.png', scale: 0.5 },
  bg1999_far: { src: 'assets/art/backgrounds/bg1999_far.png' }, bg1999_mid: { src: 'assets/art/backgrounds/bg1999_mid.png' },
  // lapisan foreground lukis (okluder dekat kamera; absen => fgSilhouette prosedural)
  bg2088_fg: { src: 'assets/art/backgrounds/bg2088_fg.png', h: 150, yOff: 36 }, bg1944_fg: { src: 'assets/art/backgrounds/bg1944_fg.png', h: 200, yOff: 72 },
  bg1968A_fg: { src: 'assets/art/backgrounds/bg1968A_fg.png', h: 150, yOff: 36 }, bg1968B_fg: { src: 'assets/art/backgrounds/bg1968B_fg.png', h: 150, yOff: 36 },
  bg1999_fg: { src: 'assets/art/backgrounds/bg1999_fg.png', h: 150, yOff: 36 },
  // properti animasi strip 3 frame (sel 200px; h = tinggi tampil px)
  prop_flag1944: { src: 'assets/art/props/prop_flag1944.png', fw: 200, fh: 200, h: 132 },
  prop_barrel2088: { src: 'assets/art/props/prop_barrel2088.png', fw: 200, fh: 200, h: 86 },
  prop_lantern1944: { src: 'assets/art/props/prop_lantern1944.png', fw: 200, fh: 200, h: 94 },
  prop_beacon1968B: { src: 'assets/art/props/prop_beacon1968B.png', fw: 200, fh: 200, h: 82 },
  prop_steam1968B: { src: 'assets/art/props/prop_steam1968B.png', fw: 200, fh: 200, h: 104 },
  prop_bulb1968A: { src: 'assets/art/props/prop_bulb1968A.png', fw: 200, fh: 200, h: 108 },
  prop_radio1968A: { src: 'assets/art/props/prop_radio1968A.png', fw: 200, fh: 200, h: 74 },
  prop_consoleWave1999: { src: 'assets/art/props/prop_consoleWave1999.png', fw: 200, fh: 200, h: 82 },
  prop_poster2088: { src: 'assets/art/props/prop_poster2088.png', fw: 200, fh: 200, h: 100 },
  prop_flare1944: { src: 'assets/art/props/prop_flare1944.png', fw: 200, fh: 200, h: 104 },
  prop_frost1999: { src: 'assets/art/props/prop_frost1999.png', fw: 200, fh: 200, h: 88 },
  // pose lukis momen kunci (menggantikan sheet pada node tertentu; h = tinggi tampil px)
  pose_elena_hold: { src: 'assets/art/characters/pose-elena-hold.png', h: 120 },
  pose_elena_kneel: { src: 'assets/art/characters/pose-elena-kneel.png', h: 104 },
  pose_arthur_tua_reach: { src: 'assets/art/characters/pose-arthur-tua-reach.png', h: 126 },
  pose_arthur_muda_vial: { src: 'assets/art/characters/pose-arthur-muda-vial.png', h: 120 },
  pose_elena_resolve: { src: 'assets/art/characters/pose-elena-resolve.png', h: 112 },
  // ilustrasi prolog 2088: latar narator + dua ekspresi Elena beresolusi tinggi
  bgnarator: { src: 'assets/art/backgrounds/narrator.png' },
  background_bawah_tanah: { src: 'assets/art/backgrounds/bunker-underground.jpg' },
  laboratorium_militer: { src: 'assets/art/backgrounds/lab-military.jpg' },
  laboratorium_akhir: { src: 'assets/art/backgrounds/lab-final.jpg' },
  watch_repair_art: { src: 'assets/art/minigames/watch-repair.png' },
  rose_bottle_broken: { src: 'assets/art/minigames/rose-bottle-broken.png' },
  water_gem_art: { src: 'assets/art/minigames/water-gem.jpg' },
  elena_arthur_photo: { src: 'assets/art/minigames/elena-arthur-photo.png' },
  bonus_city_complete: { src: 'assets/art/bonus/city-complete.jpg' },
  bonus_puzzle_board: { src: 'assets/art/bonus/puzzle-board.jpg' },
  mencariperbedaan: { src: 'assets/art/bonus/spot-difference.png' },
  mawar_art: { src: 'assets/art/bonus/rose.jpg' },
  dinner_bg: { src: 'assets/art/bonus/dinner.jpg' },
  food_spaghetti: { src: 'assets/art/bonus/spaghetti.jpg' },
  food_nasi: { src: 'assets/art/bonus/nasi-goreng.jpg' },
  food_udang: { src: 'assets/art/bonus/cheese-shrimp.jpg' },
  food_steak: { src: 'assets/art/bonus/steak.jpg' },
  cats_puzzle: { src: 'assets/art/bonus/cats.jpg' },
  chemistry_glass: { src: 'assets/art/bonus/chemistry-glass.jpg' },
  love_glass: { src: 'assets/art/bonus/love-glass.jpg' },
  mawar2_art: { src: 'assets/art/bonus/rose-variant.jpg' },
  // pasangan state halaman judul Figma: berwarna lalu monokrom (opsional; cover lama menjadi fallback)
  title_bg_color: { src: 'assets/art/ui/title-bg-color.png' },
  title_bg_mono: { src: 'assets/art/ui/title-bg-mono.png' },
  title_cover_figma: { src: 'assets/art/ui/title-cover.png' },
  title_start_plate: { src: 'assets/art/ui/title-start-plate.png' },
  title_wordmark: { src: 'assets/art/ui/title-wordmark.png' },
  time_vortex: { src: 'assets/art/backgrounds/time-vortex.png' }, // absen => pusaran ruang-waktu prosedural
  elena_dialog1: { src: 'assets/art/characters/elena-dialog.png' },
  elena_dialog2_sedih: { src: 'assets/art/characters/elena-dialog-sad.png' },
  // A2 potret bust dialog (opsional; absen => tak digambar, bubble tetap jalan)
  portrait_elena_neutral: { src: 'assets/art/characters/portrait-elena-neutral.png', h: 290 },
  portrait_elena_sad: { src: 'assets/art/characters/portrait-elena-sad.png', h: 290 },
  portrait_elena_shock: { src: 'assets/art/characters/portrait-elena-shock.png', h: 290 },
  portrait_elena_warm: { src: 'assets/art/characters/portrait-elena-warm.png', h: 290 },
  portrait_arthur_muda_shock: { src: 'assets/art/characters/portrait-arthur-muda-shock.png', h: 290 },
  portrait_arthur_muda_warm: { src: 'assets/art/characters/portrait-arthur-muda-warm.png', h: 290 },
  portrait_arthur_tua_warm: { src: 'assets/art/characters/portrait-arthur-tua-warm.png', h: 290 },
  portrait_arthur_tua_sad: { src: 'assets/art/characters/portrait-arthur-tua-sad.png', h: 290 },
  // bidang ilustrasi Figma untuk intro judul parallax (PNG transparan; absen => cover lama)
  intro01: { src: 'assets/art/onboarding/layer_01.png' }, intro02: { src: 'assets/art/onboarding/layer_02.png' }, intro03: { src: 'assets/art/onboarding/layer_03.png' },
  intro04: { src: 'assets/art/onboarding/layer_04.png' }, intro05: { src: 'assets/art/onboarding/layer_05.png' }, intro06: { src: 'assets/art/onboarding/layer_06.png' },
  intro07: { src: 'assets/art/onboarding/layer_07.png' }, intro08: { src: 'assets/art/onboarding/layer_08.png' }, intro09: { src: 'assets/art/onboarding/layer_09.png' },
  intro10: { src: 'assets/art/onboarding/layer_10.png' }, intro11: { src: 'assets/art/onboarding/layer_11.png' }, intro12: { src: 'assets/art/onboarding/layer_12.png' },
  intro13: { src: 'assets/art/onboarding/layer_13.png' }, intro14: { src: 'assets/art/onboarding/layer_14.png' }, intro15: { src: 'assets/art/onboarding/layer_15.png' },
  intro16: { src: 'assets/art/onboarding/layer_16.png' }, intro17: { src: 'assets/art/onboarding/layer_17.png' }, intro18: { src: 'assets/art/onboarding/layer_18.png' },
  intro19: { src: 'assets/art/onboarding/layer_19.png' }, intro20: { src: 'assets/art/onboarding/layer_20.png' },
};
