...
export const STORY_NODES: Record<string, StoryNodeResolver> = {
  ...
  prologue: [
    say('narrator', 'Tahun 2088. Virus Crimson menyapu 99% populasi bumi.', 'sad'),
    say('narrator', 'Arthur—kekasihku—menghembuskan napas terakhir di pelukanku pagi ini.', 'sad'),
    say('narrator', 'Satu-satunya petunjuk penawar berasal dari sebuah berkas militer era Perang Dunia II...', 'angry'),
    say('narrator', 'Aku memicu kapsul waktu darurat. Aku harus mengubah masa lalu sebelum racun itu diciptakan.', 'angry'),
    { t: 'vortex', to: '1944' },
  ],
  war_intro: [
    say('narrator', 'Semuanya bermula di sini—tahun 1944. Di tengah hujan, api, dan suara bom... kali ini aku akan menyelamatkan Arthur. Apa pun harga yang harus kubayar.', 'angry'),
    { t: 'walk', era: '1944' },
  ],
  bunker_intro: [
    say('narrator', 'Arthur berjuang di bunker bawah tanah yang seperti ini... Karena itulah aku selalu mencintainya.', 'sad'),
    say('narrator', 'Ia tak pernah menyerah, bahkan ketika dunia melupakannya.', 'sad'),
    say('narrator', 'Aku akan segera menyelamatkannya... dan membalas seluruh perjuangannya!', 'angry'),
    { t: 'walk', era: '1968' },
  ],
  lab_intro: [
    say('narrator', 'Semoga dengan seluruh fasilitas ini, Arthur akhirnya berhasil menemukan formulanya...', 'angry'),
    say('narrator', 'Formula yang mampu menebus dua puluh empat tahun penantiannya—dan menyelamatkan masa depan kami.', 'angry'),
    say('narrator', 'Kali ini, aku tidak akan membiarkan siapa pun merebut harapan itu darinya!', 'angry'),
    { t: 'walk', era: '1968' },
  ],
  final_lab_intro: [
    say('narrator', 'Akhirnya... tahun 1999. Di ruangan inilah seluruh hidup Arthur bermuara pada satu formula terakhir.', 'sad'),
    say('narrator', 'Semoga penantiannya tidak sia-sia—semoga ia telah menyelesaikan penawar yang kelak menyelamatkan dunia.', 'sad'),
    say('narrator', 'Arthur... bertahanlah sedikit lagi. Jika harapan itu masih hidup, aku akan membawanya sampai ke masa depan.', 'angry'),
    { t: 'walk', era: '1999' },
  ],
