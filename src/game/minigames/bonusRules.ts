...
export const CAT_SPOTS: readonly (readonly [number, number])[] = [
  [0.268, 0.220], [0.268, 0.440], [0.170, 0.615], [0.340, 0.540],
  [0.245, 0.740], [0.335, 0.740], [0.380, 0.725], [0.505, 0.705],
  [0.590, 0.715], [0.640, 0.285], [0.390, 0.170], [0.610, 0.180],
  [0.795, 0.280], [0.765, 0.435], [0.590, 0.525], [0.705, 0.580],
  [0.810, 0.540], [0.795, 0.730],
];
