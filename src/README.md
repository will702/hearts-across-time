...
- `game/flow.js` — runner dialog, transisi state, save, pause, koleksi pecahan ending, dan update gameplay bonus.
- `render/characters.js` — renderer Elena dan seluruh versi Arthur.
- `render/world.js` — latar, parallax, properti, partikel, dan grading.
- `render/screens.js` — render scene, cover/onboarding, HUD, vortex, glitch, endcard, papan puzzle, dan epilog kota pulih.
